...
namespace Core.Service.Impl
{
    public class ReportService : IReportService
    {
        ...
        public List<MergedClient> LoadClients()
        {
            ...
            clients.AddRange(individualClients.Select(c => new MergedClient { Id = c.Id, Name = c.Passport.FullName }));
            clients.AddRange(corporateClients.Select(c => new MergedClient { Id = c.Id, Name = c.CompanyName }));
