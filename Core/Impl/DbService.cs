...
public abstract class DbService<T> : IDbService<T> where T : class
{
    ...
    public virtual List<T> LoadEntities()
    {
        try
        {
    ...
    public virtual T? LoadEntity(Guid id)
    {
    ...
    public virtual void UpdateEntity(Guid id, T updatedEntity)
    {
        try
        {
            var entities = LoadEntities();
    ...
    public virtual Guid GetEntityId(T entity)
    {
